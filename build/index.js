...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_cross__ = __webpack_require__(136);
/* unused harmony reexport cross */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_descending__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_histogram__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_max__ = __webpack_require__(143);
/* unused harmony reexport max */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_mean__ = __webpack_require__(144);
/* unused harmony reexport mean */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_median__ = __webpack_require__(145);
/* unused harmony reexport median */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_merge__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_permute__ = __webpack_require__(147);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_scan__ = __webpack_require__(148);
/* unused harmony reexport scan */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_shuffle__ = __webpack_require__(149);
/* unused harmony reexport shuffle */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_sum__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_zip__ = __webpack_require__(151);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_path__ = __webpack_require__(102);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatDecimal__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_array__ = __webpack_require__(82);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_timer__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_timeout__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_interval__ = __webpack_require__(208);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__curve_linear__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_locale__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_formatSpecifier__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__array__ = __webpack_require__(82);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constant__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__curve_linear__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__line__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__curve_radial__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatGroup__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formatNumerals__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formatSpecifier__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__formatTypes__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__formatPrefixAuto__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatTypes__ = __webpack_require__(62);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formatDefault__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formatPrefixAuto__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_sequential__ = __webpack_require__(193);
...
var _transition = __webpack_require__(209);
...
var _stop = __webpack_require__(212);
...
var _hgraph = __webpack_require__(95);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_hgraph).default;
  }
});

var _utilities = __webpack_require__(230);

Object.defineProperty(exports, 'hGraphConvert', {
  enumerable: true,
  get: function get() {
    return _utilities.hGraphConvert;
  }
});
Object.defineProperty(exports, 'calculateHealthScore', {
  enumerable: true,
  get: function get() {
    return _utilities.calculateHealthScore;
  }
});
...
var _d3Format = __webpack_require__(32);
...
var _NodeGroup = __webpack_require__(213);

var _NodeGroup2 = _interopRequireDefault(_NodeGroup);

var _reactSvgText = __webpack_require__(219);

var _reactSvgText2 = _interopRequireDefault(_reactSvgText);
...
var HGraph = function (_Component) {
  _inherits(HGraph, _Component);

  function HGraph(props) {
    _classCallCheck(this, HGraph);

    var _this = _possibleConstructorReturn(this, (HGraph.__proto__ || Object.getPrototypeOf(HGraph)).call(this, props));
    ...
    _this.setGlobalConfig(props, false);
    var points = _this.assemblePoints(props.data);
    ...
    _this.state = {
      ...
      zoomFactor: 1,
      points: points,
      path: _this.assemblePath(points),
      animatingChildren: false,
      suppressTransition: false
    };

    _this.Format = (0, _d3Format.format)('.0%');
    return _this;
  }
  ...
  _createClass(HGraph, [{
    ...
    key: 'getDistanceAndVectorBetweenPoints',
    value: function getDistanceAndVectorBetweenPoints(point, siblingPoint) {
      var vector = [siblingPoint.cx - point.cx, siblingPoint.cy - point.cy];
      var distance = Math.sqrt(Math.pow(vector[0], 2) + Math.pow(vector[1], 2));
      var vectorNormalized = [vector[0] / distance, vector[1] / distance];
              ...
              _Animate2.default,
              {
                ...
                update: [{
                  ...
                  timing: {
                    ...
                    ease: this.state.animatingChildren ? _d3Ease.easeElastic : _d3Ease.easeExp,
              ...
              function (globalState) {
                return _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _this2.renderAxes(globalState.fontSize)
                  ),
                  _react2.default.createElement(
                    'g',
                    ...
                    _react2.default.createElement('path', {
                      ...
                      opacity: _this2.props.areaOpacity
                    })
                  ),
                  _react2.default.createElement(
                    'g',
                    { className: 'points-container' },
                    _this2.renderPoints(_this2.state.points, globalState)
                  ),
                  _react2.default.createElement(
                    'g',
                    { className: 'score-container' },
                    _react2.default.createElement(
                      _reactSvgText2.default,
                      {
                        x: '0',
                        y: '0',
                        textAnchor: 'middle',
                        verticalAnchor: 'middle',
                        fontSize: _this2.props.scoreFontSize,
                        fontWeight: 'bold',
                        pointerEvents: 'none',
                        fill: _this2.props.scoreFontColor },
                      _this2.props.score
                    )
                  )
                );
...
HGraph.propTypes = {
  data: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    ...
    healthyMin: _propTypes2.default.number.isRequired,
    healthyMax: _propTypes2.default.number.isRequired,
    absoluteMin: _propTypes2.default.number.isRequired,
    absoluteMax: _propTypes2.default.number.isRequired,
    unitLabel: _propTypes2.default.string.isRequired,
    children: _propTypes2.default.array
  })).isRequired,
  score: _propTypes2.default.number,
  color: _propTypes2.default.string,
  unhealthyPointColor: _propTypes2.default.string,
  ...
  thresholdMin: _propTypes2.default.number,
  thresholdMax: _propTypes2.default.number,
  donutHoleFactor: _propTypes2.default.number,
  healthyRangeFillColor: _propTypes2.default.string,
  fontSize: _propTypes2.default.number,
  fontColor: _propTypes2.default.string,
  showAxisLabel: _propTypes2.default.bool,
  axisLabelOffset: _propTypes2.default.number,
  axisLabelWrapWidth: _propTypes2.default.number,
  areaOpacity: _propTypes2.default.number,
  pointRadius: _propTypes2.default.number,
  pointLabelOffset: _propTypes2.default.number,
  pointLabelWrapWidth: _propTypes2.default.number,
  hitboxRadius: _propTypes2.default.number,
  showScore: _propTypes2.default.bool,
  scoreFontSize: _propTypes2.default.number,
  scoreFontColor: _propTypes2.default.string,
  zoomFactor: _propTypes2.default.number,
  zoomTransitionTime: _propTypes2.default.number,
  zoomOnPointClick: _propTypes2.default.bool,
  onPointClick: _propTypes2.default.func
};
HGraph.defaultProps = {
  width: 600,
  height: 600,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.setGlobalConfig = function (props) {
    var shouldSetState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

    _this3.labelConfigurationHeightCutoff = props.height / 6;
    _this3.labelConfigurationWidthCutoff = props.width * .1;
    _this3.radius = Math.min(props.width / 2, props.height / 2);
    _this3.rangeBottom = _this3.radius * _this3.props.donutHoleFactor;
    _this3.angleSlice = Math.PI * 2 / props.data.length;

    _this3.scaleRadial = (0, _d3Scale.scaleLinear)().domain([_this3.absoluteMin, _this3.absoluteMax]).range([_this3.rangeBottom, _this3.radius]);

    if (shouldSetState) {
      var points = _this3.assemblePoints(props.data);

      _this3.setState({
        data: props.data,
        points: points,
        path: _this3.assemblePath(points)
      });
    }
  };

  this.convertValueToHgraphPercentage = function (valueObject) {
    var value = valueObject.value,
        healthyMin = valueObject.healthyMin,
        healthyMax = valueObject.healthyMax,
        absoluteMin = valueObject.absoluteMin,
        absoluteMax = valueObject.absoluteMax;
    ...
    } else if (healthyMin < absoluteMin || healthyMax < absoluteMin || healthyMax > absoluteMax || healthyMin > absoluteMax) {
    ...
    if (healthyMin === healthyMax && value === healthyMax) {
      ...
      return _this3.props.thresholdMax - _this3.props.thresholdMin;
    } else if (value < healthyMin) {
      scale = (0, _d3Scale.scaleLinear)().domain([absoluteMin, healthyMin]).range([_this3.absoluteMin, _this3.props.thresholdMin]);
    } else if (value > healthyMax) {
      scale = (0, _d3Scale.scaleLinear)().domain([healthyMax, absoluteMax]).range([_this3.props.thresholdMax, _this3.absoluteMax]);
    } else {
      scale = (0, _d3Scale.scaleLinear)().domain([healthyMin, healthyMax]).range([_this3.props.thresholdMin, _this3.props.thresholdMax]);
    }
    return scale(value);
  };

  this.handleSvgClick = function (e) {
    if (_this3.state.zoomed) {
      _this3.zoomOut();
    }
  };

  this.handlePointClick = function (d) {
    return function (e) {
      if (_this3.props.zoomOnPointClick) {
        e.stopPropagation();

        var cos = Math.cos(d.angle - Math.PI / 2);
        var sin = Math.sin(d.angle - Math.PI / 2);

        var cx = _this3.scaleRadial(.5) * cos;
        var cy = _this3.scaleRadial(.5) * sin;

        if (_this3.state.zoomed && d.key === _this3.state.activePointId) {
          _this3.zoomOut();
        } else {
          if (!_this3.state.zoomed) {
            _this3.addChildren();
          ...
          _this3.setState({
            ...
            zoomed: true,
            zoomCoords: [cx, cy],
            zoomFactor: _this3.props.zoomFactor
          });
        }
      }

      if (_this3.props.onPointClick) {
        _this3.props.onPointClick(d.originalData, e);
      }
    };
  };
  ...
  this.buildPoint = function (d, percentageFromValue) {
    var cos = Math.cos(d.angle - Math.PI / 2);
    var sin = Math.sin(d.angle - Math.PI / 2);

    var isAboveMidPoint = percentageFromValue > _this3.props.thresholdMax - _this3.props.thresholdMin;
    var isUnhealthilyHigh = percentageFromValue > _this3.props.thresholdMax;

    var cx = _this3.scaleRadial(percentageFromValue) * cos;
    var cy = _this3.scaleRadial(percentageFromValue) * sin;

    var labelShouldRenderInside = isUnhealthilyHigh || isAboveMidPoint && cy < _this3.labelConfigurationHeightCutoff && cy > -_this3.labelConfigurationHeightCutoff;

    var labelOffset = labelShouldRenderInside ? -_this3.props.pointLabelOffset : _this3.props.pointLabelOffset;
    var labelPosition = parseFloat(percentageFromValue);
    var activeCx = (_this3.scaleRadial(labelPosition) + labelOffset) * cos;
    var activeCy = (_this3.scaleRadial(labelPosition) + labelOffset) * sin;

    var textAnchor = labelShouldRenderInside && cx < _this3.labelConfigurationWidthCutoff && cx > -_this3.labelConfigurationWidthCutoff ? 'middle' : labelShouldRenderInside && cx < -_this3.labelConfigurationWidthCutoff ? 'start' : labelShouldRenderInside && cx > _this3.labelConfigurationWidthCutoff ? 'end' : cx < -_this3.labelConfigurationWidthCutoff ? 'end' : cx > _this3.labelConfigurationWidthCutoff ? 'start' : 'middle';

    var verticalAnchor = labelShouldRenderInside && cy < _this3.labelConfigurationHeightCutoff ? 'start' : labelShouldRenderInside && cy > _this3.labelConfigurationHeightCutoff ? 'end' : labelShouldRenderInside ? 'middle' : cy < _this3.labelConfigurationHeightCutoff ? 'end' : cy > _this3.labelConfigurationHeightCutoff ? 'start' : 'middle';

    var originalData = Object.assign({}, d);
    ...
    return {
      ...
      activeCx: activeCx,
      activeCy: activeCy,
      color: _this3.thresholdColor(percentageFromValue, _this3.props.color, _this3.props.unhealthyPointColor),
      fontColor: _this3.thresholdColor(percentageFromValue, _this3.props.fontColor, _this3.props.unhealthyPointColor),
  ...
  this.assemblePath = function (points) {
    var fillString = '';
  ...
  this.assemblePoints = function (data) {
    var addingChildren = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

    var points = data.map(function (d, i) {
      var percentageFromValue = _this3.convertValueToHgraphPercentage(d);
      d.angle = addingChildren && d.angle ? d.angle : _this3.angleSlice * i;

      return _this3.buildPoint(d, percentageFromValue);
    });

    return [].concat.apply([], points);
  };

  this.assembleIntrimChildPointsForPoint = function (point, dataIndex, distance, vector, angleSliceSubdivision) {
    return point.children.map(function (c, i) {
      var copy = Object.assign({}, c);
      var frac = 1 / angleSliceSubdivision;
      copy.cx = point.cx + distance * (frac * (i + 1)) * vector[0];
      copy.cy = point.cy + distance * (frac * (i + 1)) * vector[1];
      copy.isChild = true;
      copy.angle = _this3.angleSlice * dataIndex + _this3.angleSlice / angleSliceSubdivision * (i + 1);
      return copy;
    });
  };
  ...
  this.addChildren = function () {
    // Copy the state data
    var finalData = _this3.state.data.map(function (d) {
      return d;
    });
    var intrimData = _this3.state.data.map(function (d) {
      return d;
    });
    ...
    _this3.state.data.forEach(function (data, i) {
      if (data.children && data.children.length) {
        var dataIndex = i;
        var spliceIndex = dataIndex + 1 + groupsInserted;
        var point = _this3.state.points[i];
        var siblingPoint = _this3.state.points[dataIndex + 1];
        var angleSliceSubdivision = point.children.length + 1;

        var _getDistanceAndVector = _this3.getDistanceAndVectorBetweenPoints(point, siblingPoint),
            distance = _getDistanceAndVector.distance,
            vector = _getDistanceAndVector.vector;

        var pointsIntrimChildren = _this3.assembleIntrimChildPointsForPoint(point, dataIndex, distance, vector, angleSliceSubdivision);

        point.children.map(function (c, i) {
          c.angle = _this3.angleSlice * dataIndex + _this3.angleSlice / angleSliceSubdivision * (i + 1);
          c.isChild = true;
          return c;
        });
    ...
    var intrimPoints = _this3.assemblePoints(intrimData, true);
    var intrimPath = _this3.assemblePath(intrimPoints);
    var finalPoints = _this3.assemblePoints(finalData, true);
    ...
    _this3.setState({
      ...
      _this3.setState({
        data: finalData,
        points: finalPoints,
        path: _this3.assemblePath(finalPoints),
        suppressTransition: false
      });
    });
  };
  ...
  this.removeChildren = function () {
    var finalData = _this3.state.data.filter(function (d) {
      return !d.isChild;
    });
    var finalPoints = _this3.assemblePoints(finalData);
    var finalPath = _this3.assemblePath(finalPoints);

    if (_this3.state.returnIntrimData) {
      _this3.setState({
        data: _this3.state.returnIntrimData,
        points: _this3.state.returnIntrimPoints,
        path: _this3.state.returnIntrimPath,
        animatingChildren: true,
        suppressTransition: false
      }, function () {
        setTimeout(function () {
        ...
        }, _this3.props.zoomTransitionTime + 50);
      });
    } else {
      _this3.setState({
        data: finalData,
  ...
  this.thresholdColor = function (value, color, unhealthyPointColor) {
    return value < _this3.props.thresholdMin || value > _this3.props.thresholdMax ? unhealthyPointColor : color;
  };

  this.renderThreshold = function () {
    var tau = 2 * Math.PI;
    var healthyArc = (0, _d3Shape.arc)().outerRadius(_this3.scaleRadial(_this3.props.thresholdMax)).innerRadius(_this3.scaleRadial(_this3.props.thresholdMin)).startAngle(0).endAngle(tau);
    // NOTE: totalArc just here for dev purposes for now
    var totalArc = (0, _d3Shape.arc)().outerRadius(_this3.scaleRadial(0)).innerRadius(_this3.scaleRadial(1)).startAngle(0).endAngle(tau);
    return _react2.default.createElement(
      'g',
      null,
      _react2.default.createElement('path', {
        d: healthyArc(),
        fill: _this3.props.healthyRangeFillColor,
        fillOpacity: '1' })
    );
  };

  this.renderAxisLabels = function (fontSize) {
    return _react2.default.createElement(
      'g',
      null,
      _this3.state.data.map(function (d, i) {
        var x = (_this3.scaleRadial(_this3.absoluteMax) + _this3.props.axisLabelOffset) * Math.cos(d.angle - Math.PI / 2);
        var y = (_this3.scaleRadial(_this3.absoluteMax) + _this3.props.axisLabelOffset) * Math.sin(d.angle - Math.PI / 2);
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactSvgText2.default,
            {
              ...
              width: _this3.props.axisLabelWrapWidth,
              fill: _this3.props.fontColor },
            d.label
          )
        );
      })
  ...
  this.renderAxes = function (fontSize) {
    return _react2.default.createElement(
      'g',
      null,
      _this3.renderThreshold(),
      _this3.props.showAxisLabel ? _this3.renderAxisLabels(fontSize) : null
    );
  };

  this.renderPoints = function (points, globalState) {
    return _react2.default.createElement(
      _NodeGroup2.default,
      {
        data: points,
        ...
        start: function start(d, index) {
          return {
            cx: d.cx,
            cy: d.cy,
            textOpacity: 0,
            r: d.isChild ? 0 : _this3.props.pointRadius / _this3.state.zoomFactor,
            opacity: d.isChild ? 0 : 1
          };
        },
        enter: function enter(d, index) {
          return {
            cx: d.cx,
            cy: d.cy,
            textOpacity: 0,
        ...
        update: function update(d, index) {
          var zoomed = _this3.state.zoomed;

          var radius = _this3.props.pointRadius / _this3.state.zoomFactor;
          return [{
            cx: _this3.state.suppressTransition ? d.cx : [d.cx],
            cy: _this3.state.suppressTransition ? d.cy : [d.cy],
            color: [d.color],
            r: !zoomed && d.isChild ? [1] : d.isChild ? [radius * .75] : [radius],
            opacity: !zoomed && d.isChild ? [0] : [1],
            timing: {
              duration: _this3.props.zoomTransitionTime,
              ease: d.isChild ? _d3Ease.easeElastic : _d3Ease.easeExp,
              delay: !_this3.state.animatingChildren ? 0 : zoomed && !d.isChild ? 0 : zoomed && d.isChild ? _this3.props.zoomTransitionTime : !zoomed && !d.isChild ? _this3.props.zoomTransitionTime : !zoomed && d.isChild ? 0 : 0
            }
          }, {
            textOpacity: _this3.state.zoomed ? [1] : 0,
            timing: {
              duration: _this3.props.zoomTransitionTime,
              ease: _d3Ease.easeExp,
              delay: zoomed && !d.isChild ? 0 : zoomed && d.isChild ? _this3.props.zoomTransitionTime : !zoomed && !d.isChild ? _this3.props.zoomTransitionTime : !zoomed && d.isChild ? 0 : 0
            }
          }];
        }
      },
          ...
          nodes.map(function (_ref) {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement('circle', {
                ...
                r: _this3.props.hitboxRadius || state.r,
                cx: state.cx,
                cy: state.cy,
                opacity: '0',
                onClick: _this3.handlePointClick(data) }),
              _react2.default.createElement(
                _reactSvgText2.default,
                {
                  opacity: state.textOpacity,
                  width: _this3.props.pointLabelWrapWidth,
                  x: data.activeCx,
                  y: data.activeCy,
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_arc__ = __webpack_require__(101);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_line__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_pie__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_areaRadial__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_lineRadial__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_pointRadial__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_link_index__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_symbol__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_symbol_star__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_curve_basisClosed__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_curve_basisOpen__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_curve_bundle__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_curve_cardinalClosed__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__src_curve_cardinalOpen__ = __webpack_require__(59);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__src_curve_catmullRomClosed__ = __webpack_require__(112);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__src_curve_catmullRomOpen__ = __webpack_require__(113);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_curve_linearClosed__ = __webpack_require__(114);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__src_curve_linear__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__src_curve_monotone__ = __webpack_require__(115);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__src_curve_natural__ = __webpack_require__(116);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__src_curve_step__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__src_stack__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__src_offset_expand__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__src_offset_diverging__ = __webpack_require__(120);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__src_offset_silhouette__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__src_offset_wiggle__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__src_order_ascending__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__src_order_descending__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__src_order_insideOut__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__src_order_reverse__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__descending__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__identity__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lineRadial__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_path__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__array__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constant__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__point__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pointRadial__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__symbol_star__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__constant__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cardinalClosed__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__noop__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cardinalOpen__ = __webpack_require__(59);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ascending__ = __webpack_require__(31);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__none__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ascending__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__locale__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constant__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__extent__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__identity__ = __webpack_require__(140);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_array__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_format__ = __webpack_require__(32);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_linear__ = __webpack_require__(195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_quad__ = __webpack_require__(196);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_poly__ = __webpack_require__(198);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_sin__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_exp__ = __webpack_require__(200);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_circle__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_bounce__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_elastic__ = __webpack_require__(204);
...
var _tween = __webpack_require__(210);

var _tween2 = _interopRequireDefault(_tween);

var _schedule = __webpack_require__(211);
...
var _NodeGroup = __webpack_require__(214);
...
var _mergeKeys = __webpack_require__(217);
...
var _Node = __webpack_require__(216);
...
var _reduceCssCalc = __webpack_require__(220);
...
var reduceFunctionCall = __webpack_require__(221)
var mexp = __webpack_require__(222)
...
var Mexp=__webpack_require__(223);
...
var Mexp=__webpack_require__(224);
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var Mexp=__webpack_require__(225);
...
var Mexp=__webpack_require__(226);
...
exports.getStringWidth = undefined;
...
var getStringWidthMemoized = (0, _lodash2.default)(getStringWidth);

exports.getStringWidth = getStringWidthMemoized;
...
exports.calculateHealthScore = exports.hGraphConvert = undefined;

var _metrics = __webpack_require__(231);
...
var hGraphConvert = function hGraphConvert(gender, metric, data) {
  var metricObj = _metrics2.default[gender][metric];
...
var calculateScoreFromMetric = function calculateScoreFromMetric(metric) {
  var scale = void 0;

  // TODO: Review score calcs
  if (metric.value > metric.healthyMax) {
    // if it's high, healthyMax to absoluteMax, 1 to 0
    scale = (0, _d3Scale.scaleLinear)().domain([metric.healthyMax, metric.absoluteMax]).range([1, 0]);
  } else if (metric.value < metric.healthyMin) {
    // if it's low, healthyMin to absolute Min, 1 to 0
    scale = (0, _d3Scale.scaleLinear)().domain([metric.healthyMin, metric.absoluteMin]).range([1, 0]);
  } else {
...
var calculateHealthScore = function calculateHealthScore(data) {
  // TODO: Review score calcs
  var totalWeight = 0;
  data.map(function (d) {
  ...
  data.map(function (d) {
    var score = calculateScoreFromMetric(d);
    var weightPercentage = d.weight / 100;
    var weightedScore = weightPercentage * score;
...
exports.hGraphConvert = hGraphConvert;
...
module.exports = {"male":{"totalCholesterol":{"label":"Total Cholesterol","healthyRange":[0.25,0.75],"absoluteRange":[0,1],"weight":21,"unitLabel":"mg/dl"},"ldl":{"label":"LDL Cholesterol","healthyRange":[50,130],"absoluteRange":[0,300],"weight":9,"unitLabel":"mg/dl"},"hdl":{"label":"HDL Cholesterol","healthyRange":[40,60],"absoluteRange":[0,150],"weight":9,"unitLabel":"mg/dl"},"triglycerides":{"label":"Triglycerides","healthyRange":[70,150],"absoluteRange":[0,300],"weight":3,"unitLabel":"mg/dl"},"bloodPressureSystolic":{"label":"Systolic Blood Pressure","healthyRange":[99,148],"absoluteRange":[50,230],"weight":5,"unitLabel":"mm/Hg"},"bloodPressureDiastolic":{"label":"Diastolic Blood Pressure","healthyRange":[65,95],"absoluteRange":[35,140],"weight":5,"unitLabel":"mm/Hg"},"alcoholUse":{"label":"Alcohol Use","healthyRange":[0,1],"absoluteRange":[0,20],"weight":5,"unitLabel":"drinks/week"},"nicotineUse":{"label":"Nicotine Use","healthyRange":[0,1],"absoluteRange":[0,20],"weight":5,"unitLabel":"nicotine/day"},"painLevel":{"label":"Chronic Pain","healthyRange":[0,4],"absoluteRange":[0,10],"weight":3,"unitLabel":"pain scale"},"waistCircumference":{"label":"Waist Circumference","healthyRange":[30,34.5],"absoluteRange":[0,200],"weight":10,"unitLabel":"inches"},"weight":{"label":"Weight","healthyRange":[170,205],"absoluteRange":[50,400],"weight":9,"unitLabel":"lbs"},"exercise":{"label":"Exercise","healthyRange":[3,12],"absoluteRange":[0,60],"weight":5,"unitLabel":"hours/week"},"sleep":{"label":"Sleep","healthyRange":[7.1,8],"absoluteRange":[0,18],"weight":5,"unitLabel":"hours/night"},"happiness":{"label":"Happiness","healthyRange":[6,10],"absoluteRange":[0,10],"weight":3,"unitLabel":"happiness scale"},"glucose":{"label":"Glucose","healthyRange":[61,100],"absoluteRange":[0,160],"weight":10,"unitLabel":"mg/dl"},"other":{"label":"Other","healthyRange":[0.25,0.75],"absoluteRange":[0,1],"weight":14,"unitLabel":"fake"}},"female":{"ldl":{"label":"LDL Cholesterol","healthyRange":[50,130],"absoluteRange":[0,300],"weight":9,"unitLabel":"mg/dl"},"hdl":{"label":"HDL Cholesterol","healthyRange":[40,60],"absoluteRange":[0,150],"weight":9,"unitLabel":"mg/dl"},"triglycerides":{"label":"Triglycerides","healthyRange":[70,150],"absoluteRange":[0,300],"weight":3,"unitLabel":"mg/dl"},"bloodPressureSystolic":{"label":"Systolic Blood Pressure","healthyRange":[99,148],"absoluteRange":[50,230],"weight":5,"unitLabel":"mm/Hg"},"bloodPressureDiastolic":{"label":"Diastolic Blood Pressure","healthyRange":[65,95],"absoluteRange":[35,140],"weight":5,"unitLabel":"mm/Hg"},"alcoholUse":{"label":"Alcohol Use","healthyRange":[0,1],"absoluteRange":[0,20],"weight":5,"unitLabel":"drinks/week"},"nicotineUse":{"label":"Nicotine Use","healthyRange":[0,1],"absoluteRange":[0,20],"weight":5,"unitLabel":"nicotine/day"},"painLevel":{"label":"Chronic Pain","healthyRange":[0,4],"absoluteRange":[0,10],"weight":3,"unitLabel":"pain scale"},"waistCircumference":{"label":"Waist Circumference","healthyRange":[30,34.5],"absoluteRange":[0,200],"weight":10,"unitLabel":"inches"},"weight":{"label":"Weight","healthyRange":[170,205],"absoluteRange":[50,400],"weight":9,"unitLabel":"lbs"},"exercise":{"label":"Exercise","healthyRange":[3,12],"absoluteRange":[0,60],"weight":5,"unitLabel":"hours/week"},"sleep":{"label":"Sleep","healthyRange":[7.1,8],"absoluteRange":[0,18],"weight":5,"unitLabel":"hours/night"},"happiness":{"label":"Happiness","healthyRange":[6,10],"absoluteRange":[0,10],"weight":3,"unitLabel":"happiness scale"},"glucose":{"label":"Glucose","healthyRange":[61,100],"absoluteRange":[0,160],"weight":10,"unitLabel":"mg/dl"}}}
